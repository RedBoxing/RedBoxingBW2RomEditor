    ...
    public class LZ10 : NitroCFormat
    {
                                            ...
                                            Stream outstream)
        {
            ...
            if (type != base.magicByte)
                throw new InvalidDataException(String.Format("The provided stream is not a valid LZ-0x10 compressed stream. Invalid type 0x{0}", type.ToString("X")));
            ...
            while (currentOutSize < decompressedSize)
            {
                ...
                if ((flags & mask) > 0)
                {
                    ...
                    if (disp > currentOutSize)
                        throw new InvalidDataException(String.Format("Error",
